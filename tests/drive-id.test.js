...
// parseDriveId() (server, Code.js) and extractDriveId() (client, WebEditor.js.html)
...
const { parseDriveId, looksLikeDriveUrl } = loadServer(['Config.js', 'Code.js'], ['parseDriveId', 'looksLikeDriveUrl']);
